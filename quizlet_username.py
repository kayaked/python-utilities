...
# Only one out of these i've had really good success with

def reddit():
    print("KitsuneQuizlet - Yet another exact copy of KitsuneReddit")
    ...
    import os
    for usid in array:
        req = requests.get("https://quizlet.com/{}".format(usid))
    ...
    if chec=="Y":
        g = open("qz_avail.log", 'a')
        with open("qz_avail.log", 'r') as r:
            data = r.read()
        data=data.splitlines()
